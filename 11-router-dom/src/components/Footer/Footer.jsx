        ...
        <ul class="flex flex-wrap justify-center pb-8 text-lg font-light">
            <li class="w-1/2 md:w-1/3 lg:w-1/3">
                <div class="text-center">
                    <h2 class="text-gray-800 dark:text-gray-200 text-md uppercase mb-4">
                        Components
                    </h2>
                    <ul>
                        <li class="mb-4 text-gray-800 transition-colors duration-200 hover:text-gray-800 dark:hover:text-white">
                            <a href="#">
                                Elements
                            </a>
                        </li>
