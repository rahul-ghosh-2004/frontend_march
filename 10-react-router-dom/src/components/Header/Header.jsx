                        ...
                        <div class=" flex items-center">
                            ...
                            <div class="hidden md:block">
                                <div class="flex items-baseline ml-10 space-x-4">
                                    <NavLink to="/" className={({ isActive }) => `${isActive ? "text-red-500" : "text-gray-800"} -sm font-medium`} href="/#">
                                        Blog
                                    </NavLink>
                                    <NavLink to="/teams" className={({ isActive }) => `${isActive ? "text-red-500" : "text-gray-800"} dark:text-white  hover:text-gray-800 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium`} href="/#">
                                        Teams
                                    </NavLink>
                                    <NavLink to="/faq" className={({ isActive }) => `${isActive ? "text-red-500" : "text-gray-800"} dark:text-white  hover:text-gray-800 dark:hover:text-white px-3 py-2 rounded-md text-sm font-medium`} href="/#">
                                        FAQ
                                    </NavLink>
